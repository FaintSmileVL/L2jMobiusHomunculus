 ...
 * @time : 15:28
 */
public class NpcDataOld implements IXmlReader
{
    ...
    public synchronized void load()
    {
        ...
        parseDatapackDirectory("data/stats/npcs_old", false);
     ...
     */
    public static NpcDataOld getInstance()
    {
    ...
    {
        protected static final NpcDataOld INSTANCE = new NpcDataOld();
    }
}