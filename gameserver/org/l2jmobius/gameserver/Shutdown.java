...
public class Shutdown extends Thread
{
	...
	public void run()
	{
		if (this == getInstance())
		{
			...
			{
				DatabaseBackup.performBackup(Config.BACKUP_DAYS, Config.BACKUP_PATH, Config.MYSQL_BIN_PATH, Config.DATABASE_LOGIN, Config.DATABASE_PASSWORD, Config.DATABASE_URL, "game");
			}
